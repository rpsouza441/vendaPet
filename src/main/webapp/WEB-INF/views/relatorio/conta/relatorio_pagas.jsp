...
<fmt:message key="relatorio.pagas.title" var="title" />
<customTags:page title="${title}" relatorioPagas="active">
...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
           <fmt:message key="relatorio.pagas.h1" />
      </h1>
       <ol class="breadcrumb">
        ...
        <li class="active"><a href="/relatorio/pagas"><fmt:message
    ...
    <div class="row">
      ...
      <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
            <form:form
								action="${s:mvcUrl('RCPC#relatorioPagasComSearch').build() }"
					    ...
					    <div class="col-xs-6 ">
						   ...
						   <c:if test="${not empty error}">	
	                		...
	                		<button type="button" class="close" data-dismiss="alert"
				                ...
				                <fmt:message key="procurar.relatorio.pagas.mensagem.naoEcontrado" />
								</h5>
	                       </div>
					       </c:if>
