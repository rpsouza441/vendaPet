...
<fmt:message key="relatorio.recebidas.title" var="title" />
<customTags:page title="${title}" relatorioRecebidas="active">
...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
           <fmt:message key="relatorio.recebidas.h1" />
      </h1>
       <ol class="breadcrumb">
        ...
        <li class="active"><a href="/relatorio/recebidas"><fmt:message
							key="navegacao.relatorio.contaRecebidas" /></a></li>
      </ol>
    </section>
    ...
    <div class="row">
      ...
      <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
            <form:form
								action="${s:mvcUrl('RCRC#relatorioRecebidasComSearch').build() }"
					    ...
					    <div class="col-xs-6 ">
						   ...
						   <c:if test="${not empty error}">	
	                		...
	                		<button type="button" class="close" data-dismiss="alert"
				                ...
				                <fmt:message key="procurar.relatorio.recebidas.mensagem.naoEcontrado" />
								</h5>
	                       </div>
					       </c:if>
