...
<fmt:message key="caixa.entrada.title" var="title" />
...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
           <fmt:message key="caixa.entrada.h3" />
      </h1>
      <ol class="breadcrumb">
...
<!-- 			  </h3> -->
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form:form action="${s:mvcUrl('CC#gravarEntrada').build() }" method="post"
...
<!-- 	                <div class="form-group col-lg-4 col-md-6 col-sm-12"> -->
	                ...
	                <div class="form-group col-lg-12">
	                  ...
	                  <fmt:message key="caixa.movimento.valorEntradaPlaceHolder" var="valorPlaceHolder"/>
...
<!--                 <button type="submit" class="btn btn-default">Cancel</button> -->
                	<button type="submit" class="btn btn-info pull-right btn-lg btn-block">
						<fmt:message key="caixa.button.entrada" />
					</button>
