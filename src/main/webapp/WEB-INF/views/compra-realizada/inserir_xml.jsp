...
<script src="/resources/extras/js/focusPrimeiroInput.js"></script>
  ...
  <script>
   ...
   <script src="/resources/extras/js/compraRealizada.js"></script>
...
<!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="/compra/cadastro"><fmt:message key="navegacao.entradaNF" /></a></li>
      </ol>
    </section>
...
<!-- 			  </h3> -->
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form:form action="${s:mvcUrl('CRC#gravarNF').build() }" method="post"
...
<%-- 	                  <form:input   path="valorVenda" cssClass="form-control money"  placeholder="${valorVendaPlaceHolder}" /> --%>
